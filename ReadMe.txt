In this directory, you'll find 7 crucial files: cucu.l, cucu.y, Sample1.cu, and Sample2.cu.,Lexer.txt,Parser.txt Here's how to navigate and utilize them effectively:

For Running the Program:
    A. Navigate to the directory 2022CSB1108 in your terminal.
    B. Execute the following commands sequentially:
        1. flex cucu.l
        2. bison -d cucu.y
